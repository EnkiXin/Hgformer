...
class Dataset:
    ...
    def get_interactions(self):
        """Return the internal user and item id tensors for this split.

        Hgformer's popularity and long-tail analysis hooks consume the raw id
        vectors. Keeping this accessor on the base dataset also preserves the
        behavior expected by the forked ``GeneralRecommender``.
        """
        self._check_field('uid_field', 'iid_field')
        return self.inter_feat[self.uid_field], self.inter_feat[self.iid_field]
