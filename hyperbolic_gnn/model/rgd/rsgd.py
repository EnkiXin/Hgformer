import torch.optim
from hyperbolic_gnn.model.hgcn.manifolds import ManifoldParameter, Hyperboloid
            ...
            for group in self.param_groups:
                ...
                for point in group["params"]:
                    ...
                    if momentum > 0:
                        ...
                        new_momentum_buffer = manifold.ptransp(point, new_point, momentum_buffer, torch.tensor(c))
